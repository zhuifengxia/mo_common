...
class WxPayConfig
{
    ...
    public static function init($options = [])
    {
        if (! $options) {
            $options= [
                'mchid'=> '1371917202',
                'key'=>'2lfITOGE09mq5ts7sQnb0MXhMblO0l0d',
                'appid'=>'wx102b7470b7ca0921',
                'appsecret'=>'0f0a877a033c0de252aaf86adb1d1d93',
                'sslcert_path'=>'../config/cert/apiclient_cert.pem',
                'sslkey_path'=>'../config/cert/apiclient_cert.pem',
            ];
        };
        ...
        static::$sslcert_path  = $options['sslcert_path'];
        static::$sslkey_path  = $options['sslcert_path'];
    }
}

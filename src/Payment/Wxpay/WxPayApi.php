...
use MoCommon\Payment\Wxpay\WxPayData;
use MoCommon\Payment\Wxpay\WxPayConfig;
use MoCommon\Payment\Wxpay\WxPayException;
...
class WxPayApi
{
	...
	public static function unifiedOrder($inputObj, $timeOut = 6)
	{
		...
		if(!$inputObj->IsNotify_urlSet()){
			$inputObj->SetNotify_url(WxPayConfig::NOTIFY_URI);//异步通知url
		}
